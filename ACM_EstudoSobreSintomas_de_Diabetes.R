...
#Diferentemente do Python, aqui realizamos a elaboração do mapa (full)
#sem a variável Age. Por isso logo de cara já tivemos uma inércia maior
#Entretanto, após selecionarmos apenas as variáveis desejadas os
#valores inerciais serão os mesmos nas duas linguagens 
...
#-----------------------------ESTUDO DO Chi²------------------------------
#Lembrando que χ², Chi² e Qui² se trata da mesma coisa...

#Efetuando o cruzamamento entre cada par de variáveis considerando
#como fixa a variável Resulado
...
#-------------Novo Mapa perceptual (variáveis remanescentes)--------------
...
#---------------------IMPLEMENTANDO O MÉTODO DE BURT-----------------------
